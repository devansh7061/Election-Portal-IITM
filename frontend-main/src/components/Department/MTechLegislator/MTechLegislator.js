...
import { Box, Center, Heading, HStack, Flex, Spacer } from "@chakra-ui/react";
import "./MTechLegislator.css"

function MTechLegislator({departmentCandidates}) {
...
export default MTechLegislator
