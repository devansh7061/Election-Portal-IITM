...
const main = async () => {
    ...
    // Set up the file to write the data to
    const centralPollsFilePath = "../../frontend-admin/src/pages/admin/CentralPollsData.js";
    const hostelPollsFilePath = "../../frontend-admin/src/pages/admin/HostelPollsData.js";
    const departmentPollsFilePath = "../../frontend-admin/src/pages/admin/DepartmentPollsData.js";
    ...
    try {
        ...
        fs.appendFileSync(filePath, `${hostelPollVotes}\n`);

        console.log(`View function ${getHostelPollVotes} called successfully. Result: ${hostelPollVotes}`);
    } catch (error) {
        console.error(`Error calling view function ${getHostelPollVotes}: ${error}`);
    }
    }
